...
| Priority      |  Important                             |
+---------------+----------------------------------------+
| Availability  |  50x5  Regular Business Hours          |
+---------------+----------------------------------------+
...
Service Hours:
==============
This service is considered important to Fedora and will be generally
available 24x7x365. Maintenance will be generally done outside of
"Normal Business Hours". Repairs and reported problems will have
priority over Normal, Low, 3rd Party or Deprecated services. Staff
will generally be available for on-call repairs.

Service Availability:
=====================
This service should be available for 99% per day.
